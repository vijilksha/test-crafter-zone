...
-- Add user_id column to test_sessions
...
-- Drop existing policies on test_sessions
...
-- New RLS policies for test_sessions using roles
...
-- Drop existing policies on test_results
...
-- New RLS policies for test_results using roles
